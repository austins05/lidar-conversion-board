...
while True:
    ...
    if uart_lidar.any():
        ...
        # Wait for a new frame (TF03 at 100 Hz = 10 ms)
        time.sleep_ms(10)
        # Read exactly 9 bytes (1 frame)
    ...
    # Use the last valid distance if current read fails
    ...
    uart_rs232.flush()  # Force immediate send
    sent_count += 1
    
    # Debug to REPL with absolute timestamp
